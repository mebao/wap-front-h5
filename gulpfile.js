 ...
 * 所有资源编译
 */
gulp.task('sourceBuild', ['framework-sass', 'framework-js', 'app-js', 'app-sass', 'app-images', 'components-provider', 'components-js', 'components-sass', 'html'], function () {
});
gulp.task('sourceBuild-debug', ['framework-sass-debug', 'framework-js-debug', 'app-js-debug', 'app-sass-debug', 'app-images', 'components-provider-debug', 'components-js-debug', 'components-sass-debug', 'html', 'doc-html', 'doc-js', 'doc-sass'], function () {
});
